...
* **Data**: Analyse student self-serve timetable changes[^1] and compare original and modified schedules.
...
[^1]: Students are able to make certain changes to their timetables, at activity and module level.  These changes are recorded and can be analysed.
