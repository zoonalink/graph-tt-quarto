...
But it is especially rewarding to receive feedback from subject matter experts, such as the timetabling data manager at UWE[^9], who said:

[^9]: Personal communication with Wojciech Lewicki, 19 August 2024 - when reviewing and discussion the project.
...
Universities hold a significant amount of interconnected data that can be leveraged to improve the student experience, make more informed decisions, and drive positive change. The possibilities are endless - to illustrate, I have included some blue-skies thinking in the [Appendix](appendix-blue-sky.qmd).