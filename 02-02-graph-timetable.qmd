...
Due to flexibility, creating graph data models is an iterative process: design -> build -> test -> review -> revise -\> ...and repeat. My first model was small in scope, incorporating *minimal* nodes and properties in an MVP[^4] approach.  Eventually, my expanded model was created in a cloud-instance of Neo4j Aura.
