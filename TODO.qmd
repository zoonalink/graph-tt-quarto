...
- [ ] get word count - 6500 words


- [ ] send/share zip with xiaodong
...
- [ ] save extracts to local folder for loading
- [ ] add to ignore file 
- [ ] load remaining programmes to gdrive
- [ ] load remaining programmes to neo4j
...
- [ ] update pipe files - comments, etc.
...
### making links between students and programmes/modules afterwards
```cypher
