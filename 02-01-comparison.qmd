...
Representative queries have been written in SQL and Cypher to find this insight.  The SQL query is much longer and requires six joins, each coming at a computational cost.  In contrast, the Cypher query pattern is much simpler - written in one line (MATCH pattern). 
