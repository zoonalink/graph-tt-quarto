...
Deleting nodes and relationships is an important operation in managing the graph database. Nodes and relationships can be deleted using the `DELETE` clause in Cypher.

### Deleting Nodes

Nodes can be deleted using the `DELETE` clause with the node variable. The general syntax for deleting a node is:
...
Relationships can be deleted using the `DELETE` clause with the relationship variable. The general syntax for deleting a relationship is:
